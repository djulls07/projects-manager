...
@Component({
	...
	templateUrl: '/client/imports/my-tasks-list/my-tasks-list.html',
	directives: [RouterLink, ProjectNav]
})
@RequireUser()
export class MyTasksList extends MeteorComponent {
	...
	constructor(private params: RouteParams) {
		super();
		this.autorun(() => {
			this.subscribe('tasksIOwn', params.get('projectId'), this.showSub.get(), this.search.get(), () => {
